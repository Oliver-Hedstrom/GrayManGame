...
def check_collision(attacker_pos, fence_x_position, fence_width):
    ...
    return attacker_pos >= fence_x_position and attacker_pos < (fence_x_position + fence_width)

def animate_attacker(screen, font, attacker_pos, fence_x_position, fence_width, distance):
    # Define colors
    RED = (255, 0, 0)
    WHITE = (255, 255, 255)
